...
-- ============================================================
-- 11. Payments Table
--     Balance convention: students.balance is negative when the
--     student owes money. A payment's `amount` is positive and is
--     ADDED to balance (moves it toward/past zero). A withdrawal
--     is stored as a payment with a NEGATIVE amount.
-- ============================================================
