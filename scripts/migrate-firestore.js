...
async function runMigration() {
  ...
  try {
    ...
    console.log(`🧹 Deduplicated from ${cleanedStudents.length} to ${deduplicatedStudents.length} students.`);
    ...
    console.log(`📤 Upserting ${deduplicatedStudents.length} records into Supabase "students" table...`);
